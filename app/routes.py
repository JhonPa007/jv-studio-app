...
def reporte_liquidacion():
    """
    Redirecciona a la nueva vista unificada de generación de pagos.
    """
    return redirect(url_for('finanzas.ver_planilla'))
...
def pagar_liquidacion():
    """
    Redirecciona a la nueva vista unificada de pagos.
    """
    flash("Esta función ha sido descontinuada. Use la nueva ventana de planillas.", "info")
    return redirect(url_for('finanzas.ver_planilla'))
